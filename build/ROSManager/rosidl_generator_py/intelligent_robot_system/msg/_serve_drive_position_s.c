...
bool intelligent_robot_system__msg__serve_drive_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "intelligent_robot_system.msg._serve_drive_position.ServeDrivePosition",
        full_classname_dest, 69) == 0);
  }
  intelligent_robot_system__msg__ServeDrivePosition * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ServeDrivePosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("intelligent_robot_system.msg._serve_drive_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServeDrivePosition");
