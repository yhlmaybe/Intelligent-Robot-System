...
#include "intelligent_robot_system/msg/serve_drive_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const intelligent_robot_system::msg::ServeDrivePosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<intelligent_robot_system::msg::ServeDrivePosition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ServeDrivePosition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const intelligent_robot_system::msg::ServeDrivePosition *>(
...
{
  return max_serialized_size_ServeDrivePosition(full_bounded, 0);
}

static message_type_support_callbacks_t _ServeDrivePosition__callbacks = {
...
static rosidl_message_type_support_t _ServeDrivePosition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ServeDrivePosition__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_intelligent_robot_system
const rosidl_message_type_support_t *
get_message_type_support_handle<intelligent_robot_system::msg::ServeDrivePosition>()
{
  return &intelligent_robot_system::msg::typesupport_fastrtps_cpp::_ServeDrivePosition__handle;
}
